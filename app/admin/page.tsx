...
export default function AdminPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([fetch('/api/admin/recharges'), fetch('/api/admin/payment-settings')]).then(async ([queue, config]) => {
